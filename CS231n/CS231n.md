...
$$
h_t = \tanh(W_{xh}x_t + h_{t-1}W_{hh}) \\
{\part h_t \over \part h_{t-1}} = {\part \tanh \over \part x}{ \part x \over \part h_{t-1}} \\
{\part h_t \over \part x_t} = {\part \tanh \over \part x}{ \part x \over \part x_t} 
$$
